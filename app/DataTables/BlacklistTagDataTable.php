...
class BlacklistTagDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function($record) {
                ...
                $action .= '<a class="btn btn-primary btn-sm" title="'. trans("cruds.global.view") .'" href="'.route('admin.blacklist-tag.show', $record->id).'">
                                <i class="fas fa-eye"></i>
                            </a>';
                $action .= '<a class="btn btn-info btn-sm" title="'. trans("cruds.global.edit") .'" href="'.route("admin.blacklist-tag.edit", $record->id).'">
                    <i class="fas fa-pencil-alt"></i>
                </a>';
                $action .= '<form action="'.route('admin.blacklist-tag.destroy', $record->id).'" method="POST" class="deleteForm">
     ...
     *
     * @param \App\Models\BlacklistTag $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(BlacklistTag $model)
    {
    ...
    {
        return 'BlacklistUser_' . date('YmdHis');
    }
}
