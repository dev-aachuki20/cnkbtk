...
class ChildSectionDataTable extends DataTable
{
    /**
     ...
     *
     * @param \App\Models\ChildSection $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Section $model)
    {
        return $model->where("level",config("constant.sectionLevel.level3"))->newQuery();
    }
