...
class ReportsDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        ->addColumn('poster', function($record) {
        ...
        ->rawColumns(['username','poster','reason','description','action']);
    }
    ...
    {   
        return $model->with("userData","PosterData")->newQuery();
    }
    ...
    {   
        return [
            ...
            Column::make('poster')->title(trans("cruds.reports.fields.poster")),
