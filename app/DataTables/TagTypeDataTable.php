...
class TagTypeDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function($record) {
                ...
                $action .= '<a class="btn btn-primary btn-sm" title="'. trans("cruds.global.view") .'" href="'.route('admin.tag-type.show', $record->id).'">
                                <i class="fas fa-eye"></i>
                            </a>';
                $action .= '<a class="btn btn-info btn-sm" title="'. trans("cruds.global.edit") .'" href="'.route("admin.tag-type.edit", $record->id).'">
                    <i class="fas fa-pencil-alt"></i>
                </a>';
                $action .= '<form action="'.route('admin.tag-type.destroy', $record->id).'" method="POST" class="deleteForm">
     ...
     *
     * @param \App\Models\TagType $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(TagType $model)
    {   
    ...
    {   
        return [
            ...
            Column::make('name_en')->title(trans("cruds.tag_management.tag_type.fields.title").' <small>('. trans('cruds.lang.english') .')</small>'),
            Column::make('name_ch')->title(trans("cruds.tag_management.tag_type.fields.title").' <small>('. trans('cruds.lang.chinese') .')</small>'),
