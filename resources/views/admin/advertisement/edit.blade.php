...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>{{trans("cruds.global.edit")}} {{trans("cruds.advertisement.title_singular")}}</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">{{trans("cruds.global.edit")}} {{trans("cruds.advertisement.title_singular")}}</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">{{trans("cruds.global.edit")}} {{trans("cruds.advertisement.title_singular")}}</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="{{ route('admin.advertisement.update',$advertisement->id) }}" id="addForm" enctype="multipart/form-data">
                @csrf
                @method("PATCH")
...
$('#profileImageCh').on('change', function () {
      var input = $(this)[0];
    ...
    $('#profileImageEn').on('change', function () {
      var input = $(this)[0];
      if (input.files && input.files[0]) {
          var file = input.files[0];
          var reader = new FileReader();
