<div class="card-body">
    ...
    <div class="row">
        ...
        <div class="form-group {{ $errors->has('name_en') ? 'has-error' : '' }} col-md-6">
            <label>{{trans("cruds.section_management.child_section.fields.title")}} <small>({{trans("cruds.lang.english")}})</small> <span class="required">*</span></label>
            <input type="text" oninput="this.value = this.value.replace(/[^a-zA-Z ]/g, '').replace(/(\..*)\./g, '$1');"   name="name_en" id="name_en" value="{{ old('name_en', isset($section->name_en) ? $section->name_en : '') }}" class="form-control"  placeholder="{{trans("cruds.global.enter")}} {{trans("cruds.section_management.child_section.fields.title")}}">
        ...
        <div class="form-group {{ $errors->has('name_ch') ? 'has-error' : '' }} col-md-6">
            <label>{{trans("cruds.section_management.child_section.fields.title")}} <small>({{trans("cruds.lang.chinese")}})</small> <span class="required">*</span></label>
            <input type="text"    name="name_ch" value="{{ old('name_ch', isset($section->name_ch) ? $section->name_ch : '') }}" class="form-control" id="name_ch"  placeholder="{{trans("cruds.global.enter")}} title">
        ...
        <div class="form-group {{ $errors->has('description_en') ? 'has-error' : '' }} col-md-6">
            <label>{{trans("cruds.section_management.child_section.fields.description")}} <small>({{trans("cruds.lang.english")}})</small> <span class="required">*</span></label>
            <textarea class="form-control"    name="description_en" placeholder="{{trans("cruds.global.enter")}} description " id="description_en" >{{old('description_en', isset($section->description_en) ? $section->description_en : '')}}</textarea>
        ...
        <div class="form-group {{ $errors->has('description_ch') ? 'has-error' : '' }} col-md-6">
            <label>{{trans("cruds.section_management.child_section.fields.description")}} <small>({{trans("cruds.lang.chinese")}})</small> <span class="required">*</span></label>
            <textarea class="form-control"  name="description_ch" placeholder="{{trans("cruds.global.enter")}} description " id="description_ch" >{{old('description_ch', isset($section->description_ch) ? $section->description_ch : '')}}</textarea>
         ...
         <div class="form-group {{ $errors->has('section_logo') ? 'has-error' : '' }} col-md-6">
            <label for="profileImage">{{trans("cruds.section_management.child_section.fields.section_logo")}} <small>({{trans("cruds.global.allowed_file_type_png")}})</small></label>
            <div class="input-group">
                <div class="custom-file">
                    <input type="file" id="section_logo"  class="custom-file-input" name="section_logo"  id="profileImage" accept="image/png, image/jpg, image/jpeg, image/PNG, image/JPG, image/JPEG">
        ...
        <div class="form-group {{ $errors->has('parent_id') ? 'has-error' : '' }} col-md-6">
            <label>{{trans("cruds.section_management.child_section.fields.parent_section")}} <span class="text-danger" >*</span></label>
            <select class="form-control" name="parent_id"  id="parent_id">
                <option value="">--Select--</option>
                @forelse($parentSections as $parentSection)
                <option value="{{$parentSection->id}}" {{ old('parent_id', isset($parentId) ? $parentId : '')  ==  $parentSection->id ? 'selected' : ''}}>{{$parentSection->name_en}}</option>
                @empty
        ...
        <div class="form-group {{ $errors->has('sub_parent_id') ? 'has-error' : '' }} col-md-6">
            <label>{{trans("cruds.section_management.child_section.fields.sub_section")}} <span class="text-danger" >*</span></label>
            <select class="form-control" name="sub_parent_id" id="sub_parent_id"></select>
            <span id="subparentError" class="text-danger subparentError"></span>
            @if($errors->has('sub_parent_id'))
                <span class="text-danger">{{ $errors->first('sub_parent_id') }}</span>
            @endif
        </div>

        <div class="form-group {{ $errors->has('creator_can_post') ? 'has-error' : '' }} col-md-6">
            <label>{{trans("cruds.section_management.child_section.fields.creator_can_post")}} <span class="text-danger" >*</span></label>
            <select class="form-control" name="creator_can_post"  id="creator_can_post">
        ...
        <div class="form-group {{ $errors->has('user_can_post') ? 'has-error' : '' }} col-md-6">
            <label>{{trans("cruds.section_management.child_section.fields.user_can_post")}} <span class="text-danger" >*</span></label>
        ...
        <div class="form-group {{ $errors->has('show_in_header') ? 'has-error' : '' }} col-md-6">
            <label>{{trans("cruds.section_management.child_section.fields.show_in_header")}} <span class="text-danger" >*</span></label>
        ...
        <div class="form-group {{ $errors->has('show_in_footer') ? 'has-error' : '' }} col-md-6">
            <label>{{trans("cruds.section_management.child_section.fields.show_in_footer")}} <span class="text-danger" >*</span></label>
