...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>{{trans("cruds.section_management.child_section.title_singular")}}</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">{{trans("cruds.section_management.child_section.title_singular")}}</li>
            </ol>
          </div>
  ...
  $(document).ready( function(){
     $(document).on('submit', '.deleteForm', function(e){
        ...
        swal.fire({
            ...
            text: "{{trans('cruds.section_management.child_section.delete_message')}}",
            icon: 'question',
            type: "warning",
            showCancelButton: !0,
