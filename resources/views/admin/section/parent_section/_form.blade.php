<div class="card-body">
    ...
    <div class="row">
        ...
        <div class="form-group {{ $errors->has('name_en') ? 'has-error' : '' }} col-md-6">
            <label>{{trans("cruds.section_management.parent_section.fields.title")}} <small>({{trans("cruds.lang.english")}})</small> <span class="required">*</span></label>
            <input type="text" oninput="this.value = this.value.replace(/[^a-zA-Z ]/g, '').replace(/(\..*)\./g, '$1');"   name="name_en" value="{{ old('name_en', isset($section->name_en) ? $section->name_en : '') }}" class="form-control"  placeholder="{{trans("cruds.global.enter")}} {{trans("cruds.section_management.parent_section.fields.title")}}">
        ...
        <div class="form-group {{ $errors->has('name_ch') ? 'has-error' : '' }} col-md-6">
            <label>{{trans("cruds.section_management.parent_section.fields.title")}} <small>({{trans("cruds.lang.chinese")}})</small> <span class="required">*</span></label>
            <input type="text"    name="name_ch" value="{{ old('name_ch', isset($section->name_ch) ? $section->name_ch : '') }}" class="form-control"  placeholder="{{trans("cruds.global.enter")}} {{trans("cruds.section_management.parent_section.fields.title")}}">
        ...
        <div class="form-group {{ $errors->has('description_en') ? 'has-error' : '' }} col-md-6">
            <label>{{trans("cruds.section_management.parent_section.fields.description")}} <small>({{trans("cruds.lang.english")}})</small> <span class="required">*</span></label>
            <textarea class="form-control"  name="description_en" placeholder="{{trans("cruds.global.enter")}} {{trans("cruds.section_management.parent_section.fields.description")}} " id="description_en" >{{old('description_en', isset($section->description_en) ? $section->description_en : '')}}</textarea>
        ...
        <div class="form-group {{ $errors->has('description_ch') ? 'has-error' : '' }} col-md-6">
            <label>{{trans("cruds.section_management.parent_section.fields.description")}} <small>({{trans("cruds.lang.chinese")}})</small> <span class="required">*</span></label>
            <textarea class="form-control"  name="description_ch" placeholder="{{trans("cruds.global.enter")}} {{trans("cruds.section_management.parent_section.fields.description")}} " id="description_ch" >{{old('description_ch', isset($section->description_ch) ? $section->description_ch : '')}}</textarea>
        ...
        <div class="form-group {{ $errors->has('creator_can_post') ? 'has-error' : '' }} col-md-6">
            <label>{{trans("cruds.section_management.parent_section.fields.creator_can_post")}} <span class="text-danger" >*</span></label>
        ...
        <div class="form-group {{ $errors->has('user_can_post') ? 'has-error' : '' }} col-md-6">
            <label>{{trans("cruds.section_management.parent_section.fields.user_can_post")}} <span class="text-danger" >*</span></label>
        ...
        <div class="form-group {{ $errors->has('show_in_header') ? 'has-error' : '' }} col-md-6">
            <label>{{trans("cruds.section_management.parent_section.fields.show_in_header")}} <span class="text-danger" >*</span></label>
        ...
        <div class="form-group {{ $errors->has('show_in_footer') ? 'has-error' : '' }} col-md-6">
            <label>{{trans("cruds.section_management.parent_section.fields.show_in_footer")}} <span class="text-danger" >*</span></label>
         ...
         <div class="form-group {{ $errors->has('creator_can_post') ? 'has-error' : '' }} col-md-6">
            <label>{{trans("cruds.section_management.parent_section.fields.position")}} <span class="text-danger" >*</span></label>
            <input type="text" oninput="this.value = this.value.replace(/[^0-9 ]/g, '').replace(/(\..*)\./g, '$1');"   name="position" value="{{ old('position', isset($section->position) ? $section->position : '') }}" class="form-control"  placeholder="{{trans("cruds.global.enter")}} {{trans("cruds.section_management.parent_section.fields.position")}} ">
