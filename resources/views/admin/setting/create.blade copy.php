                              ...
                              <input type="hidden" value="{{$val->id}}" name="settings[{{$key}}][id]" >
                               <input type="hidden" value="{{$val->type}}" name="settings[{{$key}}][type]" >
                                <div class="form-group">
                                    ...
                                    <input type="tel" name="settings[{{$key}}][value]" value="{{ $val->value }}" class="form-control"  placeholder="Enter {{$val->label}}" id="{{$val->key}}">
                                    @else
                                    <input type="{{$val->type}}" name="settings[{{$key}}][value]" value="{{ $val->value }}" class="form-control"  placeholder="Enter {{$val->label}}" id="{{$val->key}}">
                                    @endif
                                </div>  
                            </div>
