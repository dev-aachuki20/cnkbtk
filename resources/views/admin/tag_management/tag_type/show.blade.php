                    ...
                    <div class="card-body" style="padding:0px;">
                        <div class="table-responsive">
                            <table class="table">
                               <tbody>
                                    <tr>
                                        <th>{{trans("cruds.tag_management.tag_type.fields.title")}} <small>({{trans("cruds.lang.english")}})</small></th>
                                        <td>{{ $tagtype->name_en }}</td>
                                    </tr>
                                    <tr>
                                        <th>{{trans("cruds.tag_management.tag_type.fields.title")}} <small>({{trans("cruds.lang.chinese")}})</small></th>
                                        <td>{{ $tagtype->name_ch }}</td>
                                    </tr>
