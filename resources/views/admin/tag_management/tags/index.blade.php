          ...
          <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="pull-right">
                    <a class="btn btn-success" href="{{route('admin.tag.create')}}" style="float:right">{{trans("cruds.global.add")}} {{trans("cruds.tag_management.tag_type.title_singular")}}</a>
                </div>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
    ...
    $(document).on('change click', '.user_status', function(event) {
      ...
      .then((result) => {
          ...
          if (!result.isDismissed) {
              $.ajax({
                  type: "POST",
                  url: "{{route('admin.tag-management.tag.updateStatus')}}",
                  data: {
                      _token: "{{csrf_token()}}",
                      id: id,
                      status: status,
