        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
                ...
                <h3 class="card-title">{{trans("cruds.user.title")}}</h3>
                <div class="pull-right">
                    <a class="btn btn-success" href="{{route('admin.users.create')}}" style="float:right">{{trans("cruds.global.add")}} {{trans("cruds.user.title_singular")}}</a>
                </div>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
