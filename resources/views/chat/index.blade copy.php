  ...
  <div class="container">
    <div class="px-0 chatboxGroup open" id="chatboxGroup">
        <div class="row h-100 gx-3">
                                ...
                                <ul id="userGroupList" class="list-group rounded-0">
                                    <li class="list-group-item userporfile activeAccount active" onclick="selectUser('Shift Cancel')">
                                        ...
                                        <div class="useraccount">
                                            ...
                                            <p class="text-truncate content">Sent To : Vikram Singh Shekhawat</p>
                                        </div>
                                    </li>
            ...
            <div class="col-xxl-9 col-lg-8 col-md-7 chat-panel h-100 ">
...
<script>
    ...
    function selectUser(userOrGroup) {
        // Update the chat header with the selected user/group name
        document.getElementById('chatHeader').innerText = `Chat with ${userOrGroup}`;

        // Clear existing messages in the chat panel
        const messageContainer = document.getElementById('messageContainer');
        messageContainer.innerHTML = '';

        // Simulate loading messages (replace with actual data fetching logic)
        ...
        // Display the messages in the chat panel
    ...
    function previewImage() {
        ...
        if (fileInput.files && fileInput.files[0]) {
            ...
            reader.onload = function(e) {
                ...
                addimg.classList.remove('d-none'); // Show image preview
                document.getElementById('messageInput').value = ''; // Clear textarea input
            };
    ...
    function sendMessage() {
        ...
        if (messageText === '' && !fileInput.files[0]) {
            return; // Return if message and image are empty
        }
        ...
        if (fileInput.files[0]) {
            ...
            reader.onload = function(e) {
                ...
                displayImageMessage(imageSrc, 'You');
    ...
    // Function to display an image message in the chat panel
    function displayImageMessage(imageSrc, sender) {
        ...
        imageContent.classList.add('img-fluid', 'message-image');
    ...
    const messageInput = document.getElementById('messageInput');
        ...
        function adjustTextareaHeight() {
            ...
            // Set the height to the scroll height of the content, with a minimum of 50px
        ...
        // Call the adjustTextareaHeight function initially to set the height based on the initial content
