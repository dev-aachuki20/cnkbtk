                            ...
                            <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                                <tr>
                                    <td style="padding:0 0 36px 0;color:#153643;">
                                        <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;">Project Lock Request</p>
                                        <p>Hello {{$authUser->user_name}},</p>
                                        <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;">You sent the request mail to {{$creator->user_name}}.</p>
                                    </td>
                                </tr>
