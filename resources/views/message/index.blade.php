            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        ...
                        @else
                            <a href="{{ route('user.project.request') }}">{{ trans('cruds.create_project.project') }}
                                {{ __('cruds.create_project.request') }}</a>
                        @endif
        ...
        <div class="container">
            <div class="px-0 chatboxGroup open" id="chatboxGroup">
                <div class="row h-100 gx-3">
                                        ...
                                        <div class="col-12 mb-3">
                                            <div class="input-group searchbar">
                                                <input type="text" id="searchInput" class="form-control rounded-pill"
                                                    placeholder="{{ __('cruds.create_project.fields.user_name') }}"
                                                    aria-label="Username" aria-describedby="basic-addon1">

                                                <button
                                                    class="shadow-none btn add_btn dash-btn green-bg w-115 m-0 border-0 rounded-pill">
                                            ...
                                            <ul id="userGroupList" class="list-group rounded-0">
                                                @if (isset($creators))
                                                    @foreach ($creators as $user)
                                                        <li class="list-group-item userporfile activeAccount dynamicUserList"
                                                            ...
                                                            @php
                                                                if (
                                                                    isset($user->uploads) &&
                                                                    !empty($user->uploads) &&
                                                                    count($user->uploads) > 0
                                                                ) {
                                                                    $imagePath = asset(
                                                                        'storage/' . $user->uploads->first()->path,
                                                                    );
                                                                } else {
                                                            ...
                                                            @endphp
                                                            <div class="userimage">
                                                                <img class="userpic" src="{{ $imagePath }}"
                                                                    alt="User Image">
                                                            </div>
                                                            <div class="useraccount">
                                                                <h5 class="content"><span
                                                                        class="text-truncate">{{ ucfirst($user->user_name) }}</span>
                                                                    <span class="time"></span></h5>
                                                            </div>
                                                        </li>
                                                    @endforeach
                                                @endif
                                        ...
                                        <div class="chat-header p-3 d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="userporfile activeAccount">
                                                ...
                                                <div class="useraccount text-truncate">
                                                    <h4 class="m-0 text-truncate" id="chatHeader">
                                                        {{ ucfirst($user->user_name) }}</h4>
                                                </div>
                                            ...
                                            <div class="usersetting d-flex align-items-center gap-2">
                                                ...
                                                <button id="closeCreatorScreen"
                                                    class="btn close-btn d-md-none d-flex shadow-none border-0">
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <path
                    ...
                    @if ($ifRoleUser)
                        <div
                            class="{{ $ifRoleUser ? 'col-xxl-9 col-md-8' : 'col-xxl-12 col-lg-12' }} chat-panel h-100 chatscreen">
