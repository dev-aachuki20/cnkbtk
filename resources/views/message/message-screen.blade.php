        ...
        <div class="col-12">
            <div class="chat-header p-3 d-flex justify-content-between align-items-center">
                <div class="userporfile activeAccount">
                    ...
                    @endphp
                    <div class="userimage">
                        <img class="userpic" src="{{ $imagePath }}" alt="" height="30px" width="30px">
                    </div>
                ...
                <div class="usersetting d-flex align-items-center gap-2">
                    <div class="dropdown drop-start">
                        ...
                        <ul class="dropdown-menu border-0 p-0 rounded-3 overflow-hidden" aria-labelledby="dropdownMenuButton1" >
                            ...
                            <li class="{{$projectStatus == 1 ? 'confirmRequest' :''}}"><button type="button" class="dropdown-item del_btn dash-btn red-bg rounded-3" id="lockProjectBtn" data-project-id="{{$projectId}}" data-creator-id="{{$user->id}}" {{$projectStatus == 1 ? 'disabled' : ''}}>{{__('cruds.create_project.fields.create_project')}}</button></li>
                        </ul>
                    </div>
