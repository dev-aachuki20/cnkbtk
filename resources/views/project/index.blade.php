...
<section class="privacy-hero">
    <div class="container">
        <div class="hero-banner">
            <div class="prc-title">
                <h2>{{__('cruds.create_project.projects')}} <span>{{__('cruds.create_project.list')}}</span></h2>
            </div>
        </div>
    </div>
</section>
                        ...
                        <div class="row g-3 align-items-center">
                            <div class="col">
                                <div class="categories-left-content pe-0">
                                    ...
                                    <h5 class="categories-details-title text-nowrap"> {{__('cruds.create_project.projects')}} {{__('cruds.create_project.list')}}</h5>
                                </div>
                            </div>
                            <div class="col-auto">
                                <div class="row g-3">
