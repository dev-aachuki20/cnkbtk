                            ...
                            <div class="tag-listing">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button data-id="{{ route('statistics.members-registration',['range'=>'week'] ) }}" data-route="{{ route('statistics.members-registration') }}" class="nav-link filter-tabs aclink active" id="registered-members" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">
                                            {{trans("cruds.registered_members.title")}}
                                        </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button data-id="{{ route('statistics.number-posters',['range'=>'week'] ) }}" data-route="{{ route('statistics.number-posters') }}" class="nav-link filter-tabs aclink" id="number-posters" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">
                                            {{trans("cruds.number_of_posts.title")}}
                                        </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button data-id="{{ route('statistics.popular-posters',['range'=>'week'] ) }}" data-route="{{ route('statistics.popular-posters') }}" class="nav-link filter-tabs aclink" id="popular-posters" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">
                                            {{trans("cruds.most_popular_poster.title")}}
                                        </button>
                                    </li>

                                    <li class="nav-item" role="presentation">
                                        <button data-id="{{ route('statistics.visiting-users',['range'=>'week'] ) }}" data-route="{{ route('statistics.visiting-users') }}" class="nav-link filter-tabs aclink" id="visit-users" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">
                                            {{trans("cruds.visiting_users.title")}}
                                        </button>
                                    </li>

                                    <li class="nav-item" role="presentation">
                                        <button data-id="{{ route('statistics.mobile-access',['range'=>'week'] ) }}" data-route="{{ route('statistics.mobile-access') }}" class="nav-link filter-tabs aclink" id="mobile-access" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">
